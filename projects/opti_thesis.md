...
<!-- Apply Merriweather font globally -->
<div style="font-family:'Merriweather', Georgia, serif; color:#333333;">

  <!-- Project Title: Gradient Background like homepage -->
  <div style="
    background: linear-gradient(90deg, #9b5de5, #f08c42); 
    padding:30px; 
  ...
  <!-- Overview -->
  <h2 style="color:#9b5de5; margin-top:30px; margin-bottom:15px;">Overview</h2>
  <p>
  ...
  <!-- Data -->
  <h2 style="color:#9b5de5; margin-top:30px; margin-bottom:15px;">Data</h2>
  <ul>
  ...
  <!-- Approach -->
  <h2 style="color:#9b5de5; margin-top:30px; margin-bottom:15px;">Approach</h2>
  <ul>
  ...
  <!-- Key Findings: Light Purple Card -->
  <div style="
    ...
    border-radius:6px;
  ">
    <h2 style="color:#9b5de5; margin-top:0;">Key Findings</h2>
    <ul>
  ...
  <!-- Tools -->
  <h2 style="color:#9b5de5; margin-top:30px; margin-bottom:15px;">Tools</h2>
  <p>R, Python, Gurobi</p>
