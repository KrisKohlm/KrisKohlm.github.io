...
<!-- Full-width background with Cayman blue/green gradient -->
<div style="background: linear-gradient(90deg, #007acc, #00b894); padding:40px 0;">

  <!-- Centered text container, thin column -->
  <div style="max-width:650px; margin:0 auto; font-family:'Merriweather', Georgia, serif; color:#333333;">

    <!-- Title -->
    <h1 style="color:#ffffff; margin:0 0 30px 0;">Optimization Thesis</h1>
    ...
    <!-- Key Findings card -->
    <div style="background-color:#f0e6fa; padding:20px; border-left:5px solid #007acc; margin-bottom:30px; border-radius:6px;">
